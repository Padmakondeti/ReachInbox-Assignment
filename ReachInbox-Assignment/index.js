...
// for sending emails => (const nodemailer = require('nodemailer'));
...
app.get('/auth/google/success', isLogin, async (req, res) => {
  const html = `
        <p>Thank you so much for connecting with Us</p>
...
app.get('/', async (req, res) => {
  try {
    res
      .status(200)
      .send('Welcome to Razorsharp E-mail Outreach tool powered by AI')
  } catch (err) {
